...
| ~~3~~ | ~~**App ortu belum menyentuh Supabase**~~ | ✅ **30 Juli 2026 — siklus uang TUTUP.** Ortu masuk, membaca data nyata, dan approval inbox benar-benar menulis: 4 request diputuskan, total 484.711 → 444.711 (turun tepat sejumlah uang yang keluar), I1 tegak, `promise_debt` kembali 0, dan **anak melihat cerita ortunya** di "Where my giving went". Sisa: Send/Take/Rules/Settings/Jobs masih pratinjau; `apps/console` belum tersambung |
