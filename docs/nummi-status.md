...
| 5 | **Sort ganda belum dijaga** | dua klik cepat sama-sama membaca Unsorted 50.000 dan sama-sama menulis → saldo negatif. Tidak ada constraint yang mencegahnya; `negative_wallets` cuma **dipantau**, tidak ditegakkan. Usulan migrasi 0010 di backlog **U-9** |
