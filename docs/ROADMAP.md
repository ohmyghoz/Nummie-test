...
| **S3** | App ortu **HP saja** (web ditunda) | 3–4 akhir pekan | 🟡 **siklus uang bisa ditutup**: Dashboard · **approval inbox 5-jalur** · Send · Take · Money rules · **Settings** (uang saku, bunga bank, harga, investasi). Belum: Add a child · Missions/Jobs/Prizes builder · Insight · Transactions. **Belum persisten** sampai S1b |
